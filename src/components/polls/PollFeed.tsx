...
const mockPolls: Poll[] = [
  {
    ...
    question: 'Engagement location in two weeks: Paris or Italy?', // Updated wording to match request, "two weeks" is 14 days.
    options: [
    ...
    endsAt: daysFromNow(12), // Updated to 12 days
    totalVotes: 385,
    pledgeAmount: 50,
  },
  {
    id: '2',
    creator: { name: 'Bob The Builder', avatarUrl: 'https://placehold.co/100x100.png', profileUrl: '/profile/bob' }, // Added avatar for Bob
    ...
    endsAt: daysFromNow(30), // Updated to 30 days
    totalVotes: 390,
  },
  {
    id: '3',
    ...
    endsAt: minutesFromNow(1), // Updated to 1 minute
    totalVotes: 160,
    pledgeAmount: 5,
  },
   {
    ...
    endsAt: daysFromNow(14), // Updated to 14 days
    totalVotes: 380,
  },
  // New Polls Start Here
  {
    id: '5',
  ...
  },
  {
    ...
    options: [
      { id: '7a', text: 'Tech (Stability & Innovation)', images: ['https://placehold.co/300x200.png'], votes: 310 }, // data-ai-hint for image: "tech computer"
      { id: '7b', text: 'Art (Passion & Creativity)', images: ['https://placehold.co/300x200.png'], votes: 265 }, // data-ai-hint for image: "art painting"
    ],
  ...
  {
    id: '9',
    creator: { name: 'Hannah I.', avatarUrl: 'https://placehold.co/100x100.png', profileUrl: '/profile/hannah' }, // Same creator for follow-up
  ...
  },
  {
    ...
    question: 'My husband cheated. Stay & therapy, or take this as a sign to run?',
    options: [
  ...
  },
  {
    ...
    options: [
      { id: '12a', text: 'Workout more!', images: ['https://placehold.co/300x200.png'], votes: 100 }, // data-ai-hint for image: "gym workout"
      { id: '12b', text: 'Buy new jeans!', images: ['https://placehold.co/300x200.png'], votes: 120 }, // data-ai-hint for image: "jeans fashion"
    ],
